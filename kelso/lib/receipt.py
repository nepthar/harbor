...
def published_urls(stack: AppStack, run_data: AppRunData, ctx: KelsoCtx) -> list[str]:
...
def config_lines(stack: AppStack, ctx: KelsoCtx, *, installed: bool) -> list[str]:
...
def volume_lines(
  stack: AppStack, run_data: AppRunData | None, ctx: KelsoCtx
) -> list[str]:
